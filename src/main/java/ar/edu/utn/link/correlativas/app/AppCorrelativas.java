...
public class AppCorrelativas {
    ...
    public CommandLineRunner init(RepoMateriaJPA repo, RepoAlumnoJPA repoAlumno) {
        ...
        return (cosas) -> {
            ...
            Materia sistemaDeRepresentacion = new Materia("sistema de representacion",2);
            ...
            Alumno triston = new Alumno("triston");
            pepito.getMateriasAprobadas().add(sistemaDeRepresentacion);
